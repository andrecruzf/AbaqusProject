...
\begin{table}[ht]
\begin{center}
\caption{Nakazima FLC data points, with the critical strains at failure for each specimen width.}
...
\begin{table}[ht]
\begin{center}
\caption{Marciniak FLC data points, with the critical strains at failure for each specimen width.}
...
\begin{table}[ht]
\begin{center}
\caption{Punch-in-Punch FLC data points, with the critical strains at failure for each specimen width.}
\label{tab:pip_flc}
\begin{tabular}{@{}lcccc@{}}\toprule[1.5pt]
Width $W$ [mm] & Strain state & $\varepsilon_2$ [$-$] & $\varepsilon_1$ [$-$] & Dome fracture \\ \midrule
20  & Uniaxial tension  & -- & -- & -- \\
