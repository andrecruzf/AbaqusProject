...
for the production simulations. The punch velocity was held fixed at
\SI{5}{\milli\meter\per\second}, as established alongside the quasi-static
solution strategy in Chapter~\ref{chap:numerical_model}, so the two investigated
parameters were the mass scaling target time increment and the mesh refinement
level.
...
sweeping the global refinement factor of Section~\ref{sec:mesh_generation}, which
scales all section sizes together while leaving the sectioning unchanged
