...
otherwise continuous size trend. Scaling the fitting window with the simple
$D/10$ factor brings the curves closer to the expected punch-size ordering,
which makes it a plausible geometry-aware correction. It should still be
treated as a first candidate rather than a calibrated rule.
